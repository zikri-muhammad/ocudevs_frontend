...
export default function Navbar() {
  ...
  return (
    <div className="isolate bg-white">
      ...
      <div className="px-6 pt-6 lg:px-8 sticky top-0" id="navbarId">
      ...
      <main>
        <div className="relative px-6 lg:flex justify-center space-x-4 lg:flex-wrap">
          ...
          <div className="relative px-6 flex items-center">
            <div className="mx-auto max-w-2xl">
              <div className="text-center">
                <Image src={require("@/assets/img/nami.png")} alt="Nami" className="w-[400px]" />
              </div>
            </div>
          </div>
        </div>
